...
Misc.testMode = false -- (true/false)
...
Misc.IconSize = 30 -- 小图标尺寸
Misc.MidIconSize = 48 -- 中图标尺寸
Misc.BigIconSize = 54 -- 大图标尺寸
...
UIScale = function()
    local uiscale = min(2, max(0.64, 768 / string.match(resolution, "%d+x(%d+)")))
    return uiscale
end
...
Misc.FilgerPositions = FilgerPositions
